...
3. If the token or config is missing or invalid, say:
   "Open https://getchatdata.com/app/settings, click Copy prompt, and paste the whole prompt into the agent you are setting up. It starts by detecting Claude Code versus Codex. Do not paste raw JSON lines."
