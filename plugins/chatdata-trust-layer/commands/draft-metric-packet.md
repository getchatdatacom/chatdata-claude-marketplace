...
3. Pull the best available definition from dashboard labels, dbt docs, owner-approved raw SQL, verified reports, and owner notes.
4. Fill owners, grain, timezone, business context, caveats, freshness, validation rules, clarification rules, and escalation rules.
5. Include the expected source tie-out: raw SQL SoT, blessed dashboard/model/report, acceptable tolerance, and known exclusions.
