...
First run `chatdata_doctor`, `chatdata_pull_context`, `chatdata_list_review_queue`, and a targeted bundle or context search for the workflow being reviewed. Keep the output compact; readiness is a verdict with blockers, not a file dump.
